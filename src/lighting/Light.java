...
/**
 * The {@code Light} abstract class represents a generic light source.
 * It stores the basic property of light — its {@link Color} intensity.
 * Subclasses define how the light propagates and interacts with objects.
 */
