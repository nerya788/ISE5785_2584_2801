...
/**
 * The {@code PointLight} class represents a light source located at a specific
 * point in space. Its rays spread outward in all directions, and the intensity
 * diminishes with distance based on configurable attenuation factors.
 */
public class PointLight extends Light implements LightSource {
	...
	/**
	 * Returns the direction of the light rays from the light source to the target
	 * point.
	 *
	 * @param target the {@link Point} being illuminated
	 * @return a normalized {@link Vector} pointing from the light source to the
	 *         target
	 */
	@Override
