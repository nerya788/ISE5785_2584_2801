...
class CylinderTests {
	...
	void testFindIntersections() {
		...
		// TC09: Ray parallel and orthogonal to axis, outside tube ,length the tube (0 points)
		assertNull(tube.findIntersections(new Ray(new Point(3, 0, 0), v001)), "Ray parallel and outside tube");

		//TC10: Ray parallel and orthogonal to the tube axis, inside the tube, width the tube, down base (0 points)
		assertNull(tube.findIntersections(new Ray(new Point(1, 0.5, -1), v100)) ,"Ray is parallel and outside tube, down base, width the tube");
		
		//TC10A: Ray parallel and orthogonal to the tube axis, inside the tube, length the tube, up base (2 points)
		...
		//**** Group 6: line passes inside the tube, start with length of tube on the center
		...
		//**** Group 8: line passes inside the tube, start between the base along the tube
