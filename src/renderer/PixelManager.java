...
/**
 * Manages the distribution of pixels to multiple threads for rendering.
 * This class is thread-safe and ensures that each pixel is processed exactly once.
 * It also handles progress printing to the console.
 * Based on the course instructions for Mini-Project 2.
 */
public class PixelManager {
    ...
    /** The index of the next pixel to be processed. Using long to avoid overflow for large images. */
     ...
     * @param printInterval The interval (in seconds) for printing progress. 0 to disable.
     */
    ...
    /**
     * Atomically retrieves the next pixel to be rendered.
     * This method is synchronized to ensure thread safety.
     * @return The next {@link Pixel} to process, or {@code null} if all pixels have been dispatched.
     */
    ...
    /**
     * Notifies the manager that a pixel has been completed.
     * This method is synchronized and handles progress printing.
     */
    public synchronized void pixelDone() {
        pixelsDone++;
        if (printInterval > 0) {
            // Simple progress printing without flooding the console.
            // A more advanced implementation from the slides might use a separate object for printing.
